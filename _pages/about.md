  ...
  <div class="social-row">
    ...
    <a href="https://bsky.app/profile/laurenseestrees" target="_blank" rel="noopener noreferrer">Bluesky</a>
      ...
      <!-- <ul class="social-links">
        ...
        <li><i class="fas fa-fw fa-envelope"></i> <a href="mailto:lauren.jenkins@duke.edu">lauren.jenkins@duke.edu</a></li>
        <li><i class="ai ai-google-scholar"></i> <a href="https://scholar.google.com/citations?user=83KR35UAAAAJ&hl=en">Google Scholar</a></li>
        <li><i class="ai ai-orcid"></i> <a href="https://orcid.org/0000-0001-6537-575X">ORCID</a></li>
    ...
    <section class="photo-carousel">
      ...
      <div class = "photo-carousel-track">
        ...
        <img src="/images/about/fieldwork_maine1.jpg" alt="Fieldwork in Maine">
      </div>
